...
class ImageDetailAdapter(
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): ImageDetailAdapter.ImageViewHolder {
        val itemView =
    ...
    override fun onBindViewHolder(p0: ImageDetailAdapter.ImageViewHolder, p1: Int) {
